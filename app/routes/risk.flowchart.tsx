...
import CustomNode from '~/data/riskData/flow/CustomNodeTail'
      ...
      <div className="m-4">
        ...
        <div className="border  rounded-lg">
          <ReactFlow
              ...
              onNodesChange((prevNodes) => {
                ...
                const updatedNodes = changes.reduce((acc, change) => {
                  if (change.type === 'add') {
                    ...
                    // Remove a node
                    return acc.filter((node) => node.id !== change.nodeId)
            ...
            nodeTypes={nodeTypes}
            fitView
            className="bg-zinc-50 w-full h-[850px] flex justify-start items-center overflow-y-auto"
          ></ReactFlow>
        </div>
      </div>
    </>
