...
export default function InventoryIndex() {
  ...
  return (
    <>
      <div className="m-4">
        <Tabs defaultValue="Procurement" className="tracking-normal">
          <div className="flex ">
            {/* <h1 className="text-3xl font-bold">Inventory Review</h1> */}
            <TabsList className="">
              <TabsTrigger value="Procurement" className="relative uppercase">
                Procurement Governance
              </TabsTrigger>
              <TabsTrigger className="uppercase" value="Spend">
                Spend Analysis
              </TabsTrigger>
              <TabsTrigger className="uppercase" value="Payable">
                Payable Analysis
              </TabsTrigger>
              <TabsTrigger className="uppercase" value="Category">
                Category Analysis
              </TabsTrigger>
              <TabsTrigger className="uppercase" value="Expense">
                Expense Analysis
              </TabsTrigger>
              <TabsTrigger className="uppercase" value="SupplyDashboard">
                Supply Dashboard
              </TabsTrigger>
            </TabsList>
          </div>
