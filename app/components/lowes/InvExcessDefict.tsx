  ...
  return (
    <div>
      ...
      <div className="flex justify-between">
        <div className="w-full rounded-b-md border bg-white">
          <Table>
            <TableHeader>
              <TableRow>
        ...
        <div className="w-full mx-1 rounded-b-md border bg-white">
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead className="">Title</TableHead>
      ...
      {/* <div className="flex justify-between rounded-lg border w-100">
